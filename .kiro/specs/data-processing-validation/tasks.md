...
- [x] 0. Create 1-minute to 15-minute aggregation function
...
- [x] 1. Create validation utilities in utils/validate.py
...
- [x] 2. Create data processing functions in utils/io.py
...
- [x] 3. Wire assembly path into run_train.py
